...
import CompanyLogo from "../assets/logocapinex.png";
...
useEffect(() => {
  ...
  return (
    <nav className="fixed top-0 left-0 z-50 w-full border-b border-gray-200 bg-white py-0 px-4 font-for-nav">
      <div className="max-w-screen-2xl mx-auto flex items-center justify-between md:justify-normal md:pl-20">
        ...
        <div className="flex items-center" onClick={() => navigate("/")}>
          <img
            src={CompanyLogo}
            alt="Company Logo"
            className="h-[60px] sm:h-[70px] lg:h-[80px] object-contain logo-nav w-auto cursor-pointer"
          />
        </div>

        {/* Nav Menu */}
        <div className=" hidden md:flex marginLeft-auto flex  justify-center align items-center w-full p-4 px-8 font-semibold text-[#002060]">
          {/* Left side - Main Menu */}
          <ul className=" items-center flex space-x-6">
             {["Home","About Us",].map((menu) => (
              <li key={menu}>
                <button
                  ...
                  className="cursor-pointer font-size-for-nav hover:text-[#0EA5E9] transition duration-300"
                >
                  {menu}
                </button>
              </li>
            ...
            <li className="product-list">
              <button
                ...
                className="cursor-pointer hover:text-[#0EA5E9] font-size-for-nav transition duration-300 flex items-center"
              >
                Products
        ...
        <div className="p-4 hidden sm:block">
          <button
            ...
            className="cursor-pointer whitespace-nowrap hover:bg-[#0EA5E9] hover:text-[#002060] transition duration-300 bg-[#002060] text-white px-4 py-2 rounded-md"
          >
            Contact Us
          </button>
        </div>
        ...
        <div className="md:hidden">
          <button onClick={() => setMenuOpen(!menuOpen)} className="text-[#002060]">
        ...
        {menuOpen && (
          <div
            ref={mobileMenuRef}
            className="absolute top-full left-0 w-full bg-white shadow-md z-20 px-4 py-4 md:hidden max-h-[calc(100vh-4rem)] overflow-y-auto"
          >
            {[
              "Home",
              "About Us",
              ...
              <div key={menu} className="mb-4">
                {menu === "Products" ? (
                  <button
                    className="flex items-center justify-between w-full text-[#002060] font-medium text-base"
                  ...
                  <button
                    className="w-full text-[#002060] font-medium text-base text-left"
                    onClick={() => {
                      navigateTo(menu);
                      setMenuOpen(false);
                      setActiveDropdown(null);
                ...
                {activeDropdown === menu && (
                  <div className="mt-4 space-y-6">
                    {menu === "Products" && (
                      <>
                        <div>
                          <h3 className="font-bold text-[#002060] mb-1">
        ...
        {activeDropdown && (
          <div
            ref={desktopMenuRef}
            className={`hidden md:grid absolute top-full left-80 bg-white shadow-lg border border-gray-200 rounded-md mt-2 p-4 grid-cols-3 gap-2 w-[850px] z-50 animate-slideDown`}
          >
            {activeDropdown === "Products" && (
              <>
                <div className="ml-5 w-[160px]">
                  <h3 className="font-bold text-[#002060] mb-3">
                    Retail Loan Products
                  </h3>
                ...
                <div className="ml-5 bg-blue-50 p-6 rounded-2xl shadow-md border border-blue-100">
                  <h4 className="font-bold text-xl text-[#002060] mb-3">
                    Financial Health
                  </h4>
                  ...
                  <button
                    onClick={() => navigate("/contact-us")}
                    className="cursor-pointer bg-[#002060] text-white font-semibold px-6 py-3 rounded-full hover:bg-[#0EA5E9] hover:text-[#002060] transition"
                  >
                    Get Started
                  </button>
                </div>
